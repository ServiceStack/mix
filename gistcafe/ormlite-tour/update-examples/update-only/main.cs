...
db.UpdateOnlyFields(new Track { Year = 2001 }, onlyFields: x => x.Year, 
    where: x => x.Id == alive.Id);
...
db.UpdateOnlyFields(new Track { Name = "Still Alive", Year = 2002 }, 
...
db.UpdateOnlyFields(new Track { Name = "Staying Alive", Year = 2003 }, 
